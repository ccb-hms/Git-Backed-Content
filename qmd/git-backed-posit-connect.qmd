...
-   [master branch](https://github.com/ccb-hms/Git-Backed-Content): the analytics code to generate and save the data using [pins](https://cran.r-project.org/web/packages/pins/index.html).
-   [Quarto branch](https://github.com/ccb-hms/Git-Backed-Content/tree/Quarto): the Quarto code to generate this document (which is also deployed on the same Posit Connect server as the Shiny app).
-   [Shiny branch](https://github.com/ccb-hms/Git-Backed-Content/tree/Shiny): the code to generate the Shiny app.
